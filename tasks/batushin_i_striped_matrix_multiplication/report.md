...
- `P` - `M` - количество столбцов матрицы A (равно количеству строк матрицы B)
...
- **Эффективность MPI:** ысокая при 2 процессах (77%), снижается при увеличении числа процессов из-за роста коммуникационных затрат
